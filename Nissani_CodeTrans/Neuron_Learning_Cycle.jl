...
function NeuronLearningCycle(x::Array{Float64, 1}, w::Array{Float64,1}, θ::Array{Float64, 1}, 
                            μ₁::Array{Float64, 1}, μ₂::Array{Float64, 1}, c1::Array{Float64, 1},
                            c2::Array{Float64}, tₙ::Array{Float64, 1}, ϕ::Float64, ϵ::Float64, α::Float64, 
                            μᵉmode::Float64, μᵉpar::Float64, R_start::Int64, E_start::Int64)

    #Calculate norm, sqaured norm and dot product between w and x, in order to store the values.
